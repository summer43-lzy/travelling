...
function food(sort = "distance", cuisine = "全部") {
  ...
  return `<section class="page"><div class="page-title"><span>🍽️</span><div><p class="eyebrow">餐饮和路线均按团队动线重新整理</p><h1>美食与游玩推荐</h1></div></div><section class="panel"><div class="section-head food-section-head"><h2>富国岛当地餐厅推荐</h2></div><p class="rating-explainer">评分说明：餐厅星级以 <strong>Google 地图公开评分</strong>为主，结合公开点评页作交叉参考；距离为从南岛日落小镇 / 希尔顿区域出发的约略距离。</p><div class="food-toolbar"><div class="tabs sort-tabs" aria-label="餐厅排序方式">${[
    ["distance", "按距离"],
    ["rating", "按评分"],
  ]
    .map(
